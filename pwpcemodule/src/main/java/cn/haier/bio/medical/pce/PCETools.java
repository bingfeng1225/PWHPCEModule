...
class PCETools {
    ...
    public static final byte[] COMMANDS = {(byte) 0x81, (byte) 0x82, (byte) 0x83, (byte) 0x84};
    ...
    public static byte[] packageResponse(int command, byte[] response) {
        ...
        buffer.readBytes(frame,0,frame.length);
        buffer.resetReaderIndex();

        byte[] crc = computeCRC16Code(frame,2,frame.length - 2);
